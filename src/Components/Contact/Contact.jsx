...
const Contact = () => {
  return (
    <div >
      <h1 className="w-1/6 mx-auto text-center my-14 text-5xl flex justify-between ">Contact With Us</h1>
      <div className="w-3/6 mx-auto text-center my-14 text-5xl flex justify-between ">
      <a href=" https://www.facebook.com/ashikuraju16">
        <Icon
          className=" mb-12 transition-all duration-1000 hover:scale-150"
          icon="logos:facebook"
        />
      </a>
